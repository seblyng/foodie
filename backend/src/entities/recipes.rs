...
use super::sea_orm_active_enums::RecipeVisibility;
...
pub enum Relation {
    ...
    RecipeIngredients,
    #[sea_orm(has_many = "super::recipe_share::Entity")]
    RecipeShare,
    #[sea_orm(
...
impl Related<super::recipe_share::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RecipeShare.def()
    }
}
